...
class acf_field_gallery extends acf_field
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->l10n = array(
			'select'		=>	__("Добавить изображение в галлерею",'acf'),
			'edit'			=>	__("Редактировать изображение",'acf'),
			'update'		=>	__("Обновить изображение",'acf'),
			'uploadedTo'	=>	__("загружены к этой записи",'acf'),
			'count_0'		=>	__("Изображений не выбрано",'acf'),
			'count_1'		=>	__("Выбрано 1 изображение",'acf'),
			'count_2'		=>	__("Выбрано %d изображений",'acf'),
		);
