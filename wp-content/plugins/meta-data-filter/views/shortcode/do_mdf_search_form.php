                            ...
                            switch ($item['type'])
                            {
                                case 'slider':
                                    ...
                                    <div class="mdf_input_container" <?php if ($this_item_is_hidden): ?>style="display: none;"<?php endif; ?>>
                                        <h5 class="data-filter-section-title" style="margin-bottom: 4px;" for="<?php echo $uid ?>"><?php _e($item['name']) ?>:&nbsp;<span class="mdf_range"><input type="text" value="<?php echo $min ?>" class="mdf_range_min" data-slider-id="ui_slider_item_<?php echo $uid ?>" />
                                            ...
                                            </span> &nbsp;<?php if ($widget_options['show_slider_items_count'] AND ! $this_item_is_hidden) echo '(<span class="' . $meta_key . '">' . $items_count . '</span>)'; ?>&nbsp;<?php if (!empty($item['description'])): ?>
