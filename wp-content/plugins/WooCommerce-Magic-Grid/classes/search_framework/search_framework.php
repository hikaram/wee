	...
	if(!class_exists('PW_SEARCH_FRAMEWORK'))
	{
		...
		{		
			...
			public function build_search_form_html($fields)
			{
				...
				//ORDER
				if($pw_sf_show_orders=='on' && $pw_sf_part!='pw_woo_ad_grid_widget'){
					if(is_array($pw_sf_orders) && sizeof($pw_sf_orders)>0)
					{
						...
						if($category_taxonomy_style=='dropdown_style'){
							...
							foreach($pw_sf_orders as $orders)
							{
								...
								$items.='
								<label class="woo-checkbox-lbl woo-search-items '.$active_class.'">
									<input type="radio" name="pw_sf_orderby" value="'.$orders.'" class="'.$additional_calss.'  '.$field.$rand_id.'" '.$seleted.'/>
						...
						if($category_taxonomy_style=='dropdown_style'){
							...
							<label class="woo-checkbox-lbl woo-search-items '.($pw_sf_order_type=='ASC' ? "woo-active-check":"").'">
								<input type="radio" name="pw_sf_order_radio" value="'.$orders.'" class="pw-order '.$additional_calss.'  '.$field.$rand_id.'" data-order="ASC" value="ASC" data-form-id="#'.$pw_sf_part."_form".$rand_id.'" '.($pw_sf_order_type=='ASC' ? "checked":"").'/>
							...
							<label class="woo-checkbox-lbl woo-search-items '.($pw_sf_order_type=='DESC' ? "woo-active-check":"").'">
								<input type="radio" name="pw_sf_order_radio" value="'.$orders.'" class="pw-order '.$additional_calss.'  '.$field.$rand_id.'" data-order="DESC" value="DESC" data-form-id="#'.$pw_sf_part."_form".$rand_id.'" '.($pw_sf_order_type=='DESC' ? "checked":"").'/>
				...
				if($pw_sf_switch_icon=='on' && $pw_sf_display_type!='style_2' && $pw_sf_display_type!='style_4')
				{
				...
				if(is_array($pw_sf_fields) && sizeof($pw_sf_fields)>0 && $pw_sf_show_filters=='on' && $pw_sf_part!='pw_woo_ad_grid_widget')
				{
