		...
		*/
		.woo-tipsy-arrow-e{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'])) {
				 $custom_css .='border-left-color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'].'!important;';
			}
		$custom_css .= '}
		
		.woo-tipsy-arrow-s{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'])) {
				 $custom_css .='border-top-color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'].'!important;';
			}
		$custom_css .= '}
		.woo-tipsy-arrow-n{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'])) {
				 $custom_css .='border-bottom-color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'].'!important;';
			}
		$custom_css .= '}
		.woo-tipsy-inner{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'])) {
				 $custom_css .='background-color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_bg_color'].'!important;';
			}
		$custom_css .= '}
		.woo-tipsy-inner{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_text_color'])) $custom_css .='color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tooltip_text_color'].'!important;';
		$custom_css .= '}
		/*
		//////////////////////QUICK VIEW STYLE///////////////////
		*/
		.popup_quickview , .popup_sendto{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'popup_bg_color'])) $custom_css .='background-color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'popup_bg_color'].'!important;';
		$custom_css .= '}
		.b-modal{'; 
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'popup_overlay_color'])) $custom_css .='background-color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'popup_overlay_color'].'!important;';
		$custom_css .= '}
		...
		*/
		...
		#pw_woo_ad_grid_result'.$rand_id.'_yoursearch  span{';
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_title_color'])){
				$custom_css.='color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_title_color'].'!important;';
			}
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_fontsize'])){
				$custom_css.='font-size:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_fontsize'].'px!important;';
			}
		$custom_css.='}
		#pw_woo_ad_grid_result'.$rand_id.'_yoursearch  span.ys_items {';
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_value_color'])){
				$custom_css.='color:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_value_color'].'!important;';
			}
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_fontsize'])){
				$custom_css.='font-size:'.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'yoursearch_fontsize'].'px!important;';
			}
		...
		*/
		.wg-table-'.$rand_id.' thead tr th{';
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_head_background_color'])){
				$custom_css.='background-color: '.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_head_background_color'].';';
			}
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_head_text_color'])){
				$custom_css.='color: '.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_head_text_color'].';';
			}
		$custom_css.='
		}
		.wg-table-'.$rand_id.' tr:nth-child(even) , .wg-table-'.$rand_id.' tr:nth-child(odd){';
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_background_color'])){
				$custom_css.='background-color: '.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_background_color'].'!important;';
			}
		$custom_css.='
		}
			...
			if (isset($pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_hover_row_color'])){
				$custom_css.='background-color: '.$pw_woo_ad_main_class->custom_field[__PW_WOO_AD_SEARCH_FIELDS_PERFIX__ . 'tbl_hover_row_color'].'!important;';
			}
			$custom_css.='
			}
			.wg-table-'.$rand_id.' td {';
