<h3><div class="dashicons dashicons-hammer"></div>&nbsp;<?php _e( 'WooCommerce Tools', 'woo_pi' ); ?></h3>
<p class="description"><?php _e( 'Extend your store with other WooCommerce extensions from us.', 'woo_pi' ); ?></p>
<div id="poststuff">
			...
			<table class="form-table">
				...
				<tr>
					<td>
						...
						<p class="description"><?php _e( 'Use Store Exporter to export store details changes out of your WooCommerce store and into simple, formatted export files.', 'woo_pi' ); ?></p>
					</td>
				</tr>
