                    ...
                    <article class="entry">
                        <div class="entry-thumb image-hover2">
                            <a href="<?php the_permalink(); ?>">
                                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/data/blog-1.jpg"
                                     alt="Blog">
                            </a>
                        </div>
                        <div class="entry-ci">
...
// remove_action('woocommerce_single_product_summary', 'woocommerce_get_sidebar', 10);
...
function wc_custom_cart_redirect() {
    return get_permalink( 102 ); //dobavlenie-tovara
}
