...
// I could not invent less "indian" method to obtain active categories...
global $prod_cat_list;
$prod_cat_list = array();

function action_bcn_after_fill( $instance ) {
    global $prod_cat_list;
    foreach($instance->breadcrumbs as $item) {
	array_push($prod_cat_list, $item->get_id());
    }
};
...
bcn_init();
bcn_display(true);
remove_action( 'bcn_after_fill', 'action_bcn_after_fill', 10, 1 );
...
$args = array (
    ...
    foreach ($all_categories as $cat) {
        ...
        $bActive = in_array($cat->term_id, $prod_cat_list);
?>                        <li<?php if ($bActive) print(" class=\"active\""); ?>>
                            <!--span></span--><a href=<?php print("\"".get_term_link( (int)$cat->term_id, 'product_cat' )."\""); ?>><?php print($cat->name); ?></a>
<?php
$args2 = array(
    'hierarchical' => 1,
    'show_option_none' => '',
...
?>                            <ul <?php if ($bActive) print(" style=\"display: block;\""); ?>>
<?php 
    foreach ($subcats as $sc) {
        $bActive = in_array($sc->term_id, $prod_cat_list);
?>
                                <li<?php if ($bActive) print(" class=\"active\""); ?>><span></span><a href=<?php 
                                print("\"".get_term_link( (int)$sc->term_id, 'product_cat' )."\""); ?>><?php print($sc->name); ?></a></li>
<?php } ?>
                            </ul>
<?php } ?>
                        </li>
...
<!--
    ...
    <div class="col-left-slide left-module">
        <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
            <li><a href="#"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/data/slide-left.jpg" alt="slide-left"></a></li>
            <li><a href="#"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/data/slide-left2.jpg" alt="slide-left"></a></li>
            <li><a href="#"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/data/slide-left3.png" alt="slide-left"></a></li>
        </ul>
