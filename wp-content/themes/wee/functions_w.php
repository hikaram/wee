...
//M add_action( 'after_setup_theme', 'kt_setup' );
...
if( is_rtl() ){
    //M add_action( 'vc_base_register_front_js', 'kt_customize_fullwith_row' );
}
/**
...
//M add_action( 'widgets_init', 'kt_widgets_init' );
...
//M add_action( 'wp_head', 'kt_javascript_detection', 0 );
//M add_action( 'wp_head', 'kt_js_variables', 2 );
...
//M add_action( 'wp_enqueue_scripts', 'kt_scripts' );


//M add_action( 'admin_enqueue_scripts', 'kt_enqueue_script' );
...
//M add_filter( 'walker_nav_menu_start_el', 'kt_nav_description', 10, 4 );
...
//M add_filter( 'get_search_form', 'kt_search_form_modify' );
 ...
 * @since Kute Theme 1.0
 */
//M require THEME_DIR . '/inc/breadcrumbs.php';
 ...
 * @since Kute Theme 1.0
 */
//M require THEME_DIR . '/inc/customizer.php';
...
//M require THEME_DIR . '/inc/hooks/theme.php';

//M if( kt_is_wc() ){
    //M require THEME_DIR . '/inc/hooks/woocommerce.php';
//M }
...
//M     require_once( THEME_DIR. 'inc/nav/wp_bootstrap_navwalker.php' );
}
if( ! class_exists( 'KT_MEGAMENU' ) && file_exists( THEME_DIR. 'inc/nav/nav.php' ) ){
//M     require_once( THEME_DIR. 'inc/nav/nav.php' );
}

/**
 * Widgets
 */
//M require THEME_DIR . '/inc/widgets.php';
/**
...
//M add_filter('excerpt_more', 'kt_custom_excerpt_more');
